...
type AppendEntry struct {
	...
	PrevLogIndex      string      `protobuf:"bytes,3,opt,name=PrevLogIndex,proto3" json:"PrevLogIndex,omitempty"`
...
func (x *AppendEntry) GetPrevLogIndex() string {
	if x != nil {
...
var file_proto_replogrpc_proto_rawDesc = []byte{
	...
	0x65, 0x78, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x50, 0x72, 0x65, 0x76, 0x4c, 0x6f,
